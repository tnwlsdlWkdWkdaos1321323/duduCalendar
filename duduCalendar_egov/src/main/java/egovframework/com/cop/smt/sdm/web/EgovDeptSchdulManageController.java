...
public class EgovDeptSchdulManageController {
    ...
    throws Exception {
		...
		if(sCmd.equals("del")){
	        ...
	        System.out.println("EgovDeptSchdulManageController 상세보기 : " + deptSchdulManageVO.getSchdulId());
	        System.out.println("EgovDeptSchdulManageController 상세보기 : " + deptSchdulManageVO.getSchdulNm());
	        System.out.println("EgovDeptSchdulManageController 상세보기 : " + deptSchdulManageVO.getSchdulChargerName());
	        System.out.println("EgovDeptSchdulManageController 상세보기 : " + deptSchdulManageVO.getSchdulCn());
    ...
    throws Exception {
		...
		String sLocationUrl = "egovframework/com/cop/smt/sdm/EgovDeptSchdulManageRegist";
//		String sLocationUrl = "dudu/calendar/project/DuduProjectList";
        ...
        if(sCmd.equals("save")){
    		...
    		System.out.println("EgovDeptSchdulManageController 등록 : " + deptSchdulManageVO.getSchdulId());
	        System.out.println("EgovDeptSchdulManageController 등록 : " + deptSchdulManageVO.getSchdulNm());
	        System.out.println("EgovDeptSchdulManageController 등록 : " + deptSchdulManageVO.getSchdulChargerName());
	        System.out.println("EgovDeptSchdulManageController 등록 : " + deptSchdulManageVO.getSchdulCn());
