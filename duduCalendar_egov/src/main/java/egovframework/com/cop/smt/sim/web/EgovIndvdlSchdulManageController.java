...
public class EgovIndvdlSchdulManageController {
    ...
    throws Exception {
		...
		hmParam.put("uniqId", loginVO.getId());
    ...
    throws Exception {
		...
		System.out.println("EgovindvdlSchdulManageController 349 loginvo.getId : " + commandMap.put("id", loginVO.getId()));
    ...
    throws Exception {
        ...
        if(sCmd.equals("save")){
    		...
    		//아이디 설정
    		indvdlSchdulManageVO.setFrstRegisterId(loginVO == null ? "" : EgovStringUtil.isNullToString(loginVO.getId()));
    		indvdlSchdulManageVO.setLastUpdusrId(loginVO == null ? "" : EgovStringUtil.isNullToString(loginVO.getId()));
    		...
    		System.out.println("EgovindvdlSchdulmanageController loginVO.getId() : " + loginVO.getId());
