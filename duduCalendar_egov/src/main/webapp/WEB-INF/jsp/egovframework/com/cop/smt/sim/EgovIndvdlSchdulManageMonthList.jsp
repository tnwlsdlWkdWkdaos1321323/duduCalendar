...
<div class="sort_area">
	...
	<div class="date_view" style="left:45%;">
		<ul>
			<li style="display: none;"><a href="javascript:fnEgovSchdulTodate();" class="today"><spring:message code="comCopSmtSim.Navi.Today"/></a></li><!-- 오늘 -->
...
for(int index = 1; index <= endDay; index++)
{
	...
	if (iDayPreviewCount > 4) {
	    out.println("<TD id='id_" + iUseDate + "' valign='top' align='left' height='" + (130 + ((iDayPreviewCount - 4) * 24)) + "px' nowrap onclick=\"fn_egov_regist_IndvdlSchdulManage('" + iUseDate + "')\">");
	} else {
	    out.println("<TD id='id_" + iUseDate + "' valign='top' align='left' height='130px' nowrap onclick=\"fn_egov_regist_IndvdlSchdulManage('" + iUseDate + "')\">");
	}
		...
		for(int i=0;i < listResult.size(); i++){
			...
			if(iUseDate >= iBeginDate && iUseDate <= iBeginEnd){
				...
				if(iSchdulWeekFirest == 1 
					...
					out.print("<div class='divWeekBar' style='margin-top:" + (iDayCount * 20) + "px;position:absolute;width:" + iDotTextWidth + "px;border:solid 0px;background-color:" + egovMap.get("schdulWeekColor") + "; cursor:pointer;' onclick=\"document.getElementById('linkWeek_" + (String) egovMap.get("schdulId") + "').click()\">");
					out.print("<a id='linkWeek_" + (String) egovMap.get("schdulId") + "' href=\"JavaScript:fn_egov_detail_IndvdlSchdulManage('" + (String) egovMap.get("schdulId") + "')\" class='linkWeek'>");
					out.print((String) egovMap.get("schdulNm"));
					out.println("</a></div>");
				}				
				//일별스케줄갯수
