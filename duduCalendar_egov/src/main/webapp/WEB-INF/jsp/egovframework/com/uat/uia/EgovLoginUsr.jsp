...
<html>
<head>
<title>두두캘린더 로그인</title><!-- 로그인 -->
<meta http-equiv="content-type" content="text/html; charset=utf-8">
<link type="text/css" rel="stylesheet" href="/css/dudu/admin_login.css">
...
// 연구원 로그인 페이지에 맞도록 스크립트 설정
function hideUsr() {
    var regiUsr = document.getElementById("RegiUsr");
    var loginUsr = document.getElementById("userLogin");
    var loginAdmiin = document.getElementById("adminLogin")
    if (regiUsr && loginUsr && loginAdmiin) {
		regiUsr.style.display = 'none';
      	console.log("hideUsr() regiUsr");
      	loginAdmiin.style.display = 'none';
		console.log("hideUsr() loginUsr");
		loginUsr.style.display = 'inline-block';
    }
}

// 관리자 로그인 페이지에 맞도록 스크립트 설정
/* function hideAdmin() {
	var loginUsr = document.getElementById("userLogin");
	if (loginUsr) {
		loginUsr.style.display = 'none';
		console.log("hideAdmin() loginUsr");
	}
} */
...
<div class="login_form admin-login-wrapper">
	...
	<fieldset>
		<img src="<c:url value='/images/dudu/login/logo.png'/>" style="margin:30px 0 0px 60px" alt="login title image"  title="login title image">
		<div class="login_type">
			<div id="ulLoginType">
				<div style="display:none;"><a href="javascript:fnLoginTypeSelect('typeGnr');" id="typeGnr" title=""><spring:message code="comUatUia.loginForm.GNR"/></a></div> <!-- 일반 -->
				<div class="admin-login-title"><a href="javascript:fnLoginTypeSelect('typeEnt');" id="typeEnt" title="">
					<span id="adminLogin">관리자 로그인</span>
					<span id="userLogin" style="display: none;">연구원 로그인</span>
				</a></div>
				<div style="display:none;"><a href="javascript:fnLoginTypeSelect('typeUsr');" id="typeUsr" title=""><spring:message code="comUatUia.loginForm.USR"/></a></div> <!-- 업무 -->
			</div>
		</div>
		...
		<div class="login_input">
			<ul>
				...
				<li class="chk">
					...
					<a href="#" onclick="goRegiUsr(); return false;" id="RegiUsr">&nbsp; | &nbsp; 회원가입</a> <!-- 회원가입 -->
				</li>
				<li>
