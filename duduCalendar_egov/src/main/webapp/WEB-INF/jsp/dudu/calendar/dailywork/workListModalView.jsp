			...
			<tbody>
				<c:forEach var="workList" items="${workList}" varStatus="status">
				    <tr class="lightGrayLine">
				        ...
				        <td onclick="barUdModal('${workList.schdulId}', '${workList.schdulNm}','${workList.schdulCn}','${workList.projectId}', '${workList.schdulBgnde}', '${workList.schdulEndde}')"><c:out value="${workList.schdulNm}" /></td><!-- 일정 제목 -->
