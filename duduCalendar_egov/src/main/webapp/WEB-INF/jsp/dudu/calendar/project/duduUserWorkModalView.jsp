...
<div id="udModal" class="modal"  style="display: block;">
    <div class="modal-content">
        ...
        <form id="workUDForm" method="post">
		   ...
		   <div>
		       <input class="modalInput" id="schdulUdNm" name="schdulNm" value="${indvdlSchdulManageVO.schdulNm}" readonly="readonly">
		   </div>
		   <div>
		       <input class="modalInput" name="projectId" value="${indvdlSchdulManageVO.projectId}" onclick="projectSelect()" readonly="readonly">
		   </div>	
		   <div>
		       <input class="modalInput" name="schdulChargerName" value="${indvdlSchdulManageVO.schdulDeptId}팀  ${indvdlSchdulManageVO.schdulChargerName}" readonly="readonly">
		   </div>
		   <div>
		   ...
		   <div>
		       <textarea class="modalConInput" id="schdulUdCn" name="schdulCn" readonly="readonly"><c:out value="${indvdlSchdulManageVO.schdulCn}"/></textarea>
		   </div>
		</form>
    </div>
</div>
