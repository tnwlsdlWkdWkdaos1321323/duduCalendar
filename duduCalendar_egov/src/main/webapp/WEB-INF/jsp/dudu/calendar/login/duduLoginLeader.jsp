...
<div class="login_form admin-login-wrapper">
	...
	<fieldset>
		<div class="logo-div">
			<img src="/resources/images/blue_duduCalendar_logo.svg" class="admin-logo" alt="login title image"  title="login title image" id="leaderLogo">
		</div>
		<div class="login_type">
			<div id="ulLoginType">
				...
				<div class="admin-login-title"><a href="javascript:fnLoginTypeSelect('typeEnt');" id="typeEnt" title="">
					<span id="leaderLogin" class="admin-login">팀장 로그인</span>
				</a></div>
		...
		<div class="login_input">
			<ul>
				...
				<li>
					<img alt="팀장 아이디 입력 아이콘 " src="/resources/images/leader_id.svg" id="leaderIdIcon">
				...
				<li class="admin-list-pw">
					<img alt="팀장 비밀번호 입력 아이콘" src="/resources/images/leader_pw.svg" id="leaderPwIcon">
				...
				<li>
					...
					<input id="userLoginBtn" type="button" class="btn_login leader-login-btn" value="로그인" onclick="actionLogin()">
				</li>
