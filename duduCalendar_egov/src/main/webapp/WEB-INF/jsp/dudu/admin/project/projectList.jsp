...
<meta charset="UTF-8">
<title>프로젝트 목록</title>
<link type="text/css" rel="stylesheet" href="/resources/css/admin/projectList.css">
...
<body>
	...
	<form id="listForm" name="listForm" action="<c:url value='/dudu/admin/projectList.do'/>" method="post"> 
