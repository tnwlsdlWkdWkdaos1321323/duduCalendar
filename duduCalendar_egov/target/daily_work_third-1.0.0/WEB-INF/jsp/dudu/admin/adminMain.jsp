...
<HEAD>
	...
	<link type="text/css" rel="stylesheet" href="/resources/css/adminMain.css">
...
<header class="header">
	...
	<nav class="nav">
		<div class="leftNav">
			<a href="/dudu/calendar/mbManagement.do">연구원관리</a>
		</div>
		<div class="centerNav">
			<a href="/dudu/calendar/leaderManagement.do">팀장관리</a>
		</div>
		<div class="rightNav">
				...
				<div class="listContent">
					<c:forEach var="result" items="${resultList}" varStatus="status" >
					    <span class="listColor">
					    	<script>
							    var colors = ["#053B75", "#608080", "#2790EC", "#4BC0E2", "#004EA2", "80AFE0", "84ABBE", "74C4A4"];
	...
	<DIV class="calendar">
		<form name="deptSchdulManageVO" id="deptSchdulManageVO" action="" method="post">
			...
			for(int i = 0; i < listResult.size(); i++) {
			    ...
			    /* arrWeekColorList.add("#608080");
			    arrWeekColorList.add("#2790EC");
			    arrWeekColorList.add("#4BC0E2"); */
			}
			            ...
			            if (iUseDate >= iBeginDate && iUseDate <= iBeginEnd) {
			                ...
			                if (iSchdulWeekFirest == 1 || (iSchdulWeekFirest == 0 && iSchdulCurrent == iSchdulCurrentTotal - 1)) { //첫 토요일 보정 처리
			                    ...
			                    if(iDayCount > 3){
				                    ...
				                    out.print((String) egovMap.get("schdulNm") + " - " + (String) egovMap.get("schdulChargerId"));
				                    out.println("</a></div>");
			                    } else{
