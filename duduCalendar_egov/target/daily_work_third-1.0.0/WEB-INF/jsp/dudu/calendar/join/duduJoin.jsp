...
<div class="wTableFrm">
	...
	<div class="logo-div">
		<a href="/uat/uia/duduLoginUsr.do?mode=2">
			<img alt="연구원 회원가입 로고" src="/resources/images/sky_duduCalendar_logo.svg">
		</a>
	</div>
	<div class="wTableHead">연구원 회원가입</div>
	...
	<div class="btn regBtn">
		<!-- <input type="submit" class="s_submit" value="가입 신청" title="등록 버튼" /> -->
