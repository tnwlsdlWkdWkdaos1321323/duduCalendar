...
<!-- content start -->
<form:form commandName="adminManageVO" action="${pageContext.request.contextPath}/uss/umt/EgovAdminMberInsert.do" name="admiinManageVO" method="post" onSubmit="fnInsert(document.forms[0]); return false;"> 
...
<div class="wTableFrm">
	...
	<tbody>
		...
		<!-- 기업회원아이디 -->
		<c:set var="title"><spring:message code="comUssUmt.adminUserManageRegist.id"/></c:set>
		<tr>
