...
<c:set var="pageTitle"><spring:message code="comUssUmt.adminUserManage.title"/></c:set>
<!DOCTYPE html>
<html>
<head>
<title>${pageTitle} <spring:message code="title.create" /></title><!-- 관리자 등록 -->
<meta http-equiv="content-type" content="text/html; charset=utf-8">
<link type="text/css" rel="stylesheet" href="<c:url value='/css/egovframework/com/com.css' />">
<script type="text/javascript" src="<c:url value="/validator.do"/>"></script>
<validator:javascript formName="adminManageVO" staticJavascript="false" xhtml="true" cdata="false"/>
...
<!-- content start -->
 <form:form commandName="adminManageVO" action="${pageContext.request.contextPath}/uss/umt/EgovAdminMberSbscrb.do" name="adminManageVO" method="post" onSubmit="fnInsert(document.forms[0]); return false;"> 
